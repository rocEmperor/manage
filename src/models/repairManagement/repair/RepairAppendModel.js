...
export default {
  ...
  effects: {
    ...
    *addRecord({ payload },{ call,put }){
      const { code } = yield call(RepairManagementService.addRecord,payload);
      if(code == 20000){
