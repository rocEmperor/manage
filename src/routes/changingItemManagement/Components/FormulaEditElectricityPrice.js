...
function FormulaEditElectricityPrice({onAdd, items, onEdit}) {
  return (
    <Row>
      <Col span="8">
        <Card className="FormulaManagement-normal" title="电费公式" bordered={true}>
...
export default FormulaEditElectricityPrice;
