...
class FormulaWaterModal extends React.Component {
  constructor (props) {
    super(props);
  ...
  handleOnSubmit(e){
    this.props.form.validateFields((errors, values) => {
      ...
      } else if (Number(this.props.form.getFieldValue('price'))<=0.01) {
...
FormulaWaterModal = Form.create({})(FormulaWaterModal)
export default FormulaWaterModal
