...
function PublicAccountManagementView(props){
  ...
  function handleReset(e){
    ...
    dispatch({
      type:"PublicAccountManagementViewModel/sharedPeriodBillList",
      payload:params
    })
  }
  ...
  function handleIssue(){
    dispatch({
      type:"PublicAccountManagementViewModel/sharedPeriodpushBill",
      payload:{
        community_id:sessionStorage.getItem("communityId"),
        period_id:period_id,
      },
  ...
  function handlEcancel(){
    dispatch({
      type:"PublicAccountManagementViewModel/sharedPeriodCancelList",
      payload:{
        community_id:sessionStorage.getItem("communityId"),
        period_id:period_id,
      },
...
function mapStateToProps(state) {
  return {
    ...state.PublicAccountManagementViewModel,
    loading: state.loading.models.PublicAccountManagementViewModel,
  }
}
export default connect(mapStateToProps)(Form.create()(PublicAccountManagementView));
